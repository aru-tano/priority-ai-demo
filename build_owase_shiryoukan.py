...
CONTENT_KW = {
    ...
    '柱状節理','天然記念物',
    '熊野灘','鬼ヶ城','九鬼嘉隆','九鬼水軍','肖像画',
    '銚子川','魚飛渓','種まき権兵衛の里','キャンプinn海山',
    'ハラソ祭り','捕鯨','おわせマルシェ','マルシェ',
    '干物','ひもの','尾鷲の干物','尾鷲ブリ','定置網',
    '黒の浜','弁財島','温泉',
    '天満洞','魚見小屋',
    '向井小学校','向井地区','向井神社',
    'レストランおもてなし','古道ラーメン','らぁ麺喜鷲監修','尾鷲グルメ',
    '渡利牡蠣','渡利かき','浜千','浜千商店',
    'おわせ港まつり','花火','港まつり',
    '南海トラフ','東南海地震','防災','避難',
    '絶景','フードコート',
    'エネルギー','再生可能エネルギー','尾鷲市街',
    '熊野古道伊勢路',
}
# MEDIUM: 具体的な場所名（場所が合えば関連性は高い）
LOCATION_KW = {
    '九鬼','梶賀','三木浦','三木里','須賀利','向井','早田','賀田','曽根','古江','島勝浦',
